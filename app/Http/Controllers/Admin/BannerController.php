...
class BannerController extends Controller
{
    ...
    public function addProduct(Request $request)
    {
        ...
        {
            $getLastInsertData = BannerModel::orderBy('id','DESC')->limit(1)->get();
            ...
            if($request->hasFile('product_gallery_images_name'))
            {
                foreach($request->file('product_gallery_images_name') as $images)
                {
                    ...
                    $ProductGalleryQuery = BannerModel::insert($insertMultipleArr);
                }
    ...
    {
        $gettingProductQuery = BannerModel::where('id',$request->input('edit_product_name_first_id'))->get();
